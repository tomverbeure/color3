...
# ACDS 13.0sp1 232 linux 2018.04.14.04:38:29
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                      -work rsp_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                      -work rsp_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_rsp_xbar_mux.sv"                          -work rsp_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                      -work cmd_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_cmd_xbar_mux.sv"                          -work cmd_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_cmd_xbar_demux.sv"                        -work cmd_xbar_demux                                                                   
  ...
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_id_router_001.sv"                         -work id_router_001                                                                    
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_id_router.sv"                             -work id_router                                                                        
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_addr_router_001.sv"                       -work addr_router_001                                                                  
  vlog  "$QSYS_SIMDIR/submodules/cpu_sys_addr_router.sv"                           -work addr_router                                                                      
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                    -work nios2_qsys_0_data_master_translator_avalon_universal_master_0_agent              
